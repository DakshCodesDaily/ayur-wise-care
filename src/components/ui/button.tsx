  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        healing: "bg-gradient-accent text-accent-foreground hover:shadow-glow transform hover:scale-105 transition-bounce shadow-soft",
        therapeutic: "bg-gradient-therapeutic text-therapeutic-foreground hover:shadow-glow transform hover:scale-105 transition-bounce shadow-soft",
        gentle: "bg-accent-soft text-foreground hover:bg-accent hover:text-accent-foreground border border-accent/20 transition-smooth",
      },
      size: {
